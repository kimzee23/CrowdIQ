...
from src.domain.model.prediction import Prediction, PredictionOption, PredictionStatus, PredictionType
from src.application.port.output.prediction_repository import AbstractCategoryRepository, AbstractPredictionRepository
from src.infrastructure.persistence.models.prediction import CategoryModel, PredictionModel, PredictionOptionModel
