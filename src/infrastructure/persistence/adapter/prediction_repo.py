...
from src.domain.model.prediction import Category, Prediction, PredictionOption, PredictionStatus, PredictionType
from src.application.port.output.prediction_repository import AbstractCategoryRepository, AbstractPredictionRepository
from src.infrastructure.persistence.entity.prediction import CategoryModel, PredictionModel, PredictionOptionModel
