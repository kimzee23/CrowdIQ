...
from src.application.services.vote_service import VoteService
from src.application.services.wallet_service import WalletService
from src.domain.user.entity import User
from src.infrastructure.postgres.database import get_db
from src.infrastructure.postgres.repositories.comment_repo import PostgresCommentRepository
from src.infrastructure.postgres.repositories.notification_repo import PostgresNotificationRepository
from src.infrastructure.postgres.repositories.prediction_repo import (
    PostgresCategoryRepository,
    PostgresPredictionRepository,
)
from src.infrastructure.postgres.repositories.reputation_repo import (
    PostgresReputationRepository,
    PostgresWalletRepository,
)
from src.infrastructure.postgres.repositories.user_repo import PostgresUserRepository
from src.infrastructure.postgres.repositories.vote_repo import PostgresVoteRepository
