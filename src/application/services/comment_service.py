...
from src.domain.comment.entity import Comment
from src.domain.comment.repository import AbstractCommentRepository
from src.domain.prediction.repository import AbstractPredictionRepository
from src.domain.user.entity import User
from src.shared.exceptions.base import ForbiddenError, NotFoundError
from src.shared.utils.helpers import generate_uuid, utc_now
